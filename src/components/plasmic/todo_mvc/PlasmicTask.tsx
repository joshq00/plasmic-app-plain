...
import * as sty from "./PlasmicTask.module.css"; // plasmic-import: ycr20lmMt4Z/css
    ...
    >
      <div
        className={classNames(
          ...
          sty.freeBox__fRatr,
          {
            [sty.freeBox__state_editing__fRatrUvJsD]: hasVariant(
              variants,
              "state",
              "editing"
            ),
            [sty.freeBox__state_editing_global_theme_dark__fRatrUvJsDGFk4V]:
              hasVariant(variants, "state", "editing") &&
              hasVariant(globalVariants, "theme", "dark")
          }
        )}
        ...
        {(hasVariant(variants, "state", "editing") ? false : true) ? (
          <div
            className={classNames(
              ...
              sty.freeBox__cE8MW,
              {
                [sty.freeBox__state_checked__cE8MWz3ZX9]: hasVariant(
                  variants,
                  "state",
                  "checked"
                ),
                [sty.freeBox__state_checked_global_theme_dark__cE8MWz3ZX9GFk4V]:
                  hasVariant(variants, "state", "checked") &&
                  hasVariant(globalVariants, "theme", "dark"),
                [sty.freeBox__state_editing__cE8MWUvJsD]: hasVariant(
                  variants,
                  "state",
                  "editing"
                )
      ...
      <div
        className={classNames(
          ...
          sty.freeBox__uWkeV,
          {
            [sty.freeBox__global_theme_dark__uWkeVgFk4V]: hasVariant(
              globalVariants,
              "theme",
              "dark"
            ),
            [sty.freeBox__state_editing__uWkeVUvJsD]: hasVariant(
              variants,
              "state",
              "editing"
            ),
            [sty.freeBox__state_editing_global_theme_dark__uWkeVUvJsDGFk4V]:
              hasVariant(variants, "state", "editing") &&
              hasVariant(globalVariants, "theme", "dark")
          }
        )}
        ...
        {(hasVariant(variants, "state", "editing") ? false : true) ? (
          <div
            className={classNames(
              ...
              sty.freeBox__m4Ith,
              {
                [sty.freeBox__state_checked__m4IthZ3ZX9]: hasVariant(
                  variants,
                  "state",
                  "checked"
                ),
                [sty.freeBox__state_editing__m4IthUvJsD]: hasVariant(
                  variants,
                  "state",
                  "editing"
                )
        ...
        {(hasVariant(variants, "state", "editing") ? false : true) ? (
          <div
            className={classNames(
              ...
              sty.freeBox___1Aqf,
              {
                [sty.freeBox__state_editing___1AqfUvJsD]: hasVariant(
                  variants,
                  "state",
                  "editing"
                )
