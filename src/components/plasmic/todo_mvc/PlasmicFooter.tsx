...
import ToggleButton from "../../ToggleButton"; // plasmic-import: ycU_Phqe2UI/component
...
import * as sty from "./PlasmicFooter.module.css"; // plasmic-import: gSYNnNwHbQn/css
...
function PlasmicFooter__RenderFunc(props: {
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(
            ...
            sty.freeBox__owLbK,
            {
              [sty.freeBox__state_empty__owLbKm7J2Q]: hasVariant(
                variants,
                "state",
                "empty"
              ),
              [sty.freeBox__state_hasCompleted__owLbKchPUb]: hasVariant(
                variants,
                "state",
                "hasCompleted"
              ),
              [sty.freeBox__state_singularLeft__owLbKJjn]: hasVariant(
                variants,
                "state",
                "singularLeft"
              )
          ...
          {(hasVariant(variants, "state", "singularLeft") ? true : true) ? (
            <div
              className={classNames(
                ...
                sty.text__bAobx,
                {
                  [sty.text__state_empty__bAobxm7J2Q]: hasVariant(
                    variants,
                    "state",
                    "empty"
                  ),
                  [sty.text__state_hasCompleted__bAobxchPUb]: hasVariant(
                    variants,
                    "state",
                    "hasCompleted"
                  ),
                  [sty.text__state_singularLeft__bAobxJjn]: hasVariant(
                    variants,
                    "state",
                    "singularLeft"
                  )
      ...
      >
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__f1F3J)}
        ...
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__tixgl)}
        >
          {"Completed"}
        </ToggleButton>

        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton___7H3La)}
        >
          {"Active"}
        </ToggleButton>
      </p.Stack>
      ...
      {(hasVariant(variants, "state", "hasCompleted") ? true : false) ? (
        <div
          className={classNames(
            ...
            sty.text__jZm29,
            {
              [sty.text__state_hasCompleted__jZm29ChPUb]: hasVariant(
                variants,
                "state",
                "hasCompleted"
              )
